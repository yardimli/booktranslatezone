	...
	<div class="bg-card text-card-foreground p-8 rounded-lg shadow-md w-full max-w-md border">
		...
		<?php
			if(isset($_GET['reg']) && $_GET['reg'] == 'success'){
				echo '<div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">Registration successful! Please log in.</div>';
			}
			if(!empty($login_err)){
		...
		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
			...
			<div class="flex items-center justify-between">
				...
				<a class="inline-block align-baseline font-bold text-sm text-primary hover:opacity-80" href="register.php">
